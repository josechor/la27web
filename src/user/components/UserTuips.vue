...
onMounted(async () => {
  tuips.value = await tuipsFetchApi.getTuips(page, limit, {authorId: props.userId});
...
async function loadMoreTweets() {
  ...
  page++;
  const tuipsResponse = await tuipsFetchApi.getTuips(page, limit, {authorId: props.userId});
